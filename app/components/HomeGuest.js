  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      ...
      case "passwordAfterDelay":
        ...
        return
      case "submitForm":
        if (!draft.username.haErrors && draft.username.isUnique && !draft.email.hasErrors && draft.email.isUnique && !draft.password.hasErrors) {
          draft.submitCount++
        }
        return
    }
      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            ...
            <button onClick={handleSubmit} type="submit" className="py-3 mt-4 btn btn-lg btn-success btn-block">
